...
There were `r length(unique(spinal_allergy_sub$person_id))` subjects with a spinal procedure.

```{r, echo =F,warning=F,message=F,comment=NA}

allergen_classified=spinal_allergy_sub%>%
...
```{r, echo =F,warning=F,message=F,comment=NA,include=F}
allergen_classified%>%
